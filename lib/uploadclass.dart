...
class _UploadScreenState extends State<UploadScreen> {
    ...
    try {
      final response = await http.post(
        // Uri.parse(AppConstants.LIVE_URL + 'api/journey-log/list'),
          Uri.parse(AppConstants.UNITMASTER),
  ...
  Future<void> endjourney(lat,lang,openlogid) async {
    ...
    var body = {
      ...
      "id":int.parse(openlogid),
      "journey_date":AppConstants.cdate,
      "rm_id":int.parse(sessionrouteid),
      "driver_id":int.parse(sessiondriverID),
      "end_apt_id":0,
      "end_lat":lat,
      "end_lon":lang,
      ...
      "measurement_id":selecttypeid.toString().isEmpty?"0":int.parse(selecttypeid.toString()),
      "waste_id":2,
    ...
    try {
      final response = await http.post(
          Uri.parse(AppConstants.ENDJOURNEY),
          body: jsonEncode(body),
          headers: headers);
      print(jsonEncode(body));
      print(headers);
